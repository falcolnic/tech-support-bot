...
from exceptions.chats import ChatListRequestError, ListenerListRequestError, SendMessageToChatError
...
from services.converters.chats import convert_chat_listener_response_to_chat_listener_dto, convert_chat_response_to_chat_dto
...
class ChatWebService(BaseChatWebService):
    ...
    async def get_chat_listeners(self, chat_oid: str) -> list[ChatListenerDTO]:
        ...
        return [convert_chat_listener_response_to_chat_listener_dto(
